        ...
        <div id='contact' className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className='flex justify-between w-1/12 mb-2'>
                ...
                <div className='md:w-6/12'>
                    <form ref={form} onSubmit={sendEmail} className='md:mx-3' role='form'>
                        ...
                        type="submit"
                        value="Send"
                        className="group mb-2 relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700"
                        />
                    </form>
                </div>
            </div>
